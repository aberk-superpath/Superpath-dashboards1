// ============================================================
// NATASHA DASHBOARD — Google Ads MCC Script
...
var CONFIG = {
  ...
  EXCLUDED_ACCOUNT_IDS: [
    '515-048-2349',  // (LSA) ProBuilt Hawaii Roofing & Rain Gutters - Maui
    '248-407-5054',  // (LSA) ProBuilt Hawaii Roofing & Rain Gutters - Oahu
    '401-203-0950'   // ProBuilt Hawaii Roofing & Rain GuttersKauai (LSA)
  ]
};
...
function main() {
  ...
  Logger.log('Found ' + accounts.length + ' accounts labeled "' + CONFIG.LABEL + '" (LSA accounts excluded)');
...
function clearAccountRows(sheet, accountIds) {
  ...
  // Clear all data rows, then rewrite only the rows we're keeping
