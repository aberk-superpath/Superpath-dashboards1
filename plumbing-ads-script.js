// ============================================================
// PLUMBING DASHBOARD — Google Ads MCC Script (merged)
...
function main() {
  ...
  var tabs = {
    campaign: getOrCreate(ss, 'Campaign Data', HEADERS.campaign),
    keyword:  getOrCreate(ss, 'Keyword Data',  HEADERS.keyword)
  };
