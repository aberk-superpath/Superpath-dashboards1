...
var CONFIG = {
  ...
  EXCLUDED_ACCOUNT_IDS: [
    '890-069-9088',  // (LSA) Aldrich Legal Services
    '853-981-1944',  // (LSA) Casper's Heating & Cooling
    '674-929-6413',  // (LSA) Clover Heating & Cooling
    '733-579-8724',  // (LSA) Premier Indoor Comfort
    '899-209-6048'   // (LSA) Randy's Electric
  ]
};
